...
\begin{enumerate}  
	\item Normalize data introducing Dummy Variables and transform feature in numerical data
	\item Calculate and plot Pearson correlation coefficient (PCC) on each pair of features to  show the dependencies between features
	\item Calculate the three different types of Naive Bayes classifier and compare the incorrect prediction results
	\item Calculate the model metrics using the Gaussian Naive Bayes 
	\item Calculate the probability of each class (dead or survived)
