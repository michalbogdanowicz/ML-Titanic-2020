...
\begin{enumerate}
	...
	\item As it can be seen from the graph (Graph  \ref{figure:graph-nn-scalevsnoscale}) . As it can be seen the non-scaled version is much less "smooth" but much faster. It could be based on the simplification of having a lot of 0 values in the data.
